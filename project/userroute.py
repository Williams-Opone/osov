...
def google_login():
    ...
    if os.environ.get('VERCEL'):
        redirect_uri = "https://osov-zg9q-lakvlfc12-oponeboboola-3463s-projects.vercel.app/auth/callback"
    else:
...
def contact_us():
    ...
    if request.method == 'POST':
        ...
        logo_url = "https://osov-zg9q-lakvlfc12-oponeboboola-3463s-projects.vercel.app/static/logoest.svg" 
